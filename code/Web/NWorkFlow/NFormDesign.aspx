...
if(str=="20")
{
    ...
    {           
        ...
        eWebEditor1.insertHTML('<SELECT id="Drop'+cValue+'"  name="Drop'+cValue+'" alt="'+document.getElementById("TextBox11").value+'" >   '+TempOptionStr+'  </SELECT>');
...
else if(str=="1")
{
    ...
    eWebEditor1.insertHTML('<input id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox5").value+'"  type="text"  style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="2")
{
    ...
    eWebEditor1.insertHTML('<textarea id="TextArea'+cValue+'" name="TextArea'+cValue+'"  alt="'+document.getElementById("TextBox7").value+'"   cols="20" rows="2"  style="SCROLLBAR-FACE-COLOR:   #AAAAAA;   SCROLLBAR-HIGHLIGHT-COLOR:   #D8D8D8;  SCROLLBAR-SHADOW-COLOR:   #D8D8D8;   SCROLLBAR-3DLIGHT-COLOR:   #D8D8D8;   SCROLLBAR-ARROW-COLOR:   #D8D8D8;   SCROLLBAR-TRACK-COLOR:   #D8D8D8;   SCROLLBAR-DARKSHADOW-COLOR:   #D8D8D8; border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000 " ></textarea>');
...
else if(str=="3")
{
    ...
    eWebEditor1.insertHTML('<input id="CHK'+cValue+'"  name="CHK'+cValue+'" alt="'+document.getElementById("TextBox9").value+'"  type="checkbox"  />');
...
else if(str=="13")
{
    ...
    eWebEditor1.insertHTML('<input id="Date'+cValue+'" name="Date'+cValue+'" alt="'+document.getElementById("TextBox8").value+'"    type="text"  onclick="setday(this)"   value=""  style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="14")
{
    ...
    eWebEditor1.insertHTML('<img class="HerCss" name="img'+cValue+'" alt="'+document.getElementById("TextBox2").value+'" id="img'+cValue+'" onclick="selectyinzhang(img'+cValue+');"  src="../images/Button/InsertYinZhang.gif" />');
...
else if(str=="104")
{
    ...
    eWebEditor1.insertHTML('<img class="HerCss" name="img'+cValue+'" alt="'+document.getElementById("TextBox16").value+'" id="img'+cValue+'" onclick="selectShouXie(img'+cValue+');"  src="../images/Button/InsertQianMing.gif" />');
...
else if(str=="4")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'" name="Text'+cValue+'" alt="'+document.getElementById("TextBox1").value+'" type="text" value="宏控件-用户姓名" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="5")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'" name="Text'+cValue+'" alt="'+document.getElementById("TextBox3").value+'" type="text" value="宏控件-用户部门" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="6")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox4").value+'"  type="text" value="宏控件-用户角色" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="7")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox10").value+'" type="text" value="宏控件-用户职位" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="8")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox12").value+'" type="text" value="宏控件-当前日期" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="101")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox13").value+'" onclick="selectUser(Text'+cValue+');"  type="text" value="点击选择用户" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="102")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'" alt="'+document.getElementById("TextBox14").value+'" onclick="selectBuMen(Text'+cValue+');"  type="text" value="点击选择部门" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
...
else if(str=="103")
{
    ...
    eWebEditor1.insertHTML('<input readonly id="Text'+cValue+'"  name="Text'+cValue+'"  alt="'+document.getElementById("TextBox15").value+'" type="text" value="宏控件-部门主管" style="border-left:0px;border-top:0px;border-right:0px;border-bottom:1px   solid   #000000"/>');
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;流程表单&nbsp;>>&nbsp;表单设计器</td>
            ...
            <tr>
            <td height="3px" colspan="1" style="background-color: #ffffff"></td>
...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	<tr>
	<td style="width: 208px; height: 25px; background-color: #cccccc; text-align: center; vertical-align:top;" align="right">
        <strong>标准控件</strong>
        ...
        中文名：<asp:TextBox ID="TextBox9" runat="server" Width="90px"></asp:TextBox><br /><hr />
        ...
        中文名：<asp:TextBox ID="TextBox16" runat="server" Width="90px"></asp:TextBox></td>
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff; vertical-align:top;" >
        <asp:TextBox ID="TxtContent" runat="server" Style="display: none"></asp:TextBox><iframe id="eWebEditor1" frameborder="0" height="520" scrolling="no" src="../eWebEditor/ewebeditor.htm?id=TxtContent&style=mini"
            width="99%"></iframe>
        <br />
        <span style="color: #ff0000">1.点击左边控件按钮将会把内容插入到编辑器中鼠标的光标所在处，如果鼠标的光标没有在编辑器中将不会插入内容。<br />
        </span><span style="color: #ff0000">2.如果页面中存在重复的字段，系统在运行中将取页面上最后一个控件的值。如果最后一个控件没有值，系统默认为未取到值。</span></td></tr>
</table>
		</div>
	</form>
</body>
