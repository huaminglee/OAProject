<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SetNodeWrite.aspx.cs" Inherits="NWorkFlow_SetNodeWrite" %>
<html>
	<head>
	...
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff; text-align: center;" >
        <table bgcolor="#999999" border="0" cellpadding="2" cellspacing="1" style="width: 600px">
            ...
            <tr>
                ...
                <td align="right" style="width: 170px; height: 25px; background-color: #cccccc; text-align: center">
