...
public partial class Office_SheBeiAdd : System.Web.UI.Page
{
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.ShangCiSuYuanDate = this.txtShangCiSuYuanDate.Value.ToString();
        Model.JiHuaSuYaunDate = this.txtJiHuaSuYaunDate.Value.ToString();
        ...
        Model.QianZiDate = this.txtQianZiDate.Value.ToString();
		Model.ZhengGai=this.txtZhengGai.Text.ToString();
        Model.ChuCiSuYuanDate = this.txtChuCiSuYuanDate.Value.ToString();
        Model.QiYongDate = this.txtQiYongDate.Value.ToString();
        ...
        Model.TiXingDate = this.txtTiXingDate.Value.ToString();
