...
public partial class Office_BookJieHuanModify : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.txtJieShuDate.Value = Model.JieShuDate.ToString();
            this.txtGuiHuanDate.Value = Model.GuiHuanDate.ToString();
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.JieShuDate = this.txtJieShuDate.Value.ToString();
        Model.GuiHuanDate = this.txtGuiHuanDate.Value.ToString();
