    ...
    <table style="width: 100%">
            ...
            <td>
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ID" HeaderText="唯一标识"></asp:BoundField>
                        <asp:TemplateField HeaderText="显示文字">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "TreeListView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "TextStr")%></asp:HyperLink>
                            </ItemTemplate>
        ...
        <tr>
            <td style="border-top: #000000 1px solid; border-bottom: #000000 1px solid">
                ...
                &nbsp; <strong><span style="color: red">注：此功能仅限开发人员使用，客户严禁操作，可能引起系统损坏！</span></strong>
            </td>
        </tr>
    </table>
    </form>
