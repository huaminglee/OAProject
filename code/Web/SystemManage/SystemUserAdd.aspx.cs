...
public partial class SystemManage_SystemUserAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ////判断是否超过最大用户限制
        //int AllowNum = 0;
        //int NowNum = int.Parse(ZWL.DBUtility.DbHelperSQL.GetSHSLInt("select count(*) from ERPUser"));
        //try
        //{
        //    AllowNum = int.Parse(ZWL.Common.DEncrypt.DESEncrypt.Decrypt(ZWL.DBUtility.DbHelperSQL.GetSHSL("select top 1 UserNum from ERPSerils"), "www.baidu.com"));
        //}
        //catch
        //{ }
        //// if (NowNum<AllowNum)
        ...
        if (ZWL.Common.PublicMethod.IFExists("UserName", "ERPUser", 0, this.TextBox1.Text) == true)
        {
            if (ZWL.Common.PublicMethod.IFExists("Serils", "ERPUser", 0, this.TextBox4.Text) == true)
            {
                ...
                MyBuMen.BirthDay = this.TextBox12.Value;
                ...
                MyBuMen.CanJiaGongZuoTime = this.TextBox23.Value;
                MyBuMen.JiaRuBenDanWeiTime = this.TextBox24.Value;
                ...
                MyBuMen.Cardno = this.txtCardNo.Text.Trim();
                MyBuMen.Tel = this.txtTel.Text.Trim();
                MyBuMen.Add();
                //写系统日志
        ...
        //else
        //{
        //    ZWL.Common.MessageBox.Show(this, "该系统已经达到最大允许用户数量，新用户信息不允许添加！");
        //}
    }
