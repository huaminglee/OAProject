            ...
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    部门：<asp:TextBox ID="TextBox2" runat="server" Height="20px" Width="60px"></asp:TextBox><img
                        class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectDanWei.aspx?TableName=ERPBuMen&LieName=BuMenName&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox2').value=wName;}"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="用户名">
                            <ItemTemplate>
                                ...
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "SystemUserView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "UserName")%></asp:HyperLink>
                        ...
                        <asp:BoundField DataField="TrueName" HeaderText="姓名"></asp:BoundField>
                        <asp:BoundField DataField="Serils" HeaderText="员工编号"></asp:BoundField>
                        <asp:BoundField DataField="Department" HeaderText="所属部门"></asp:BoundField>
                        <asp:BoundField DataField="JiaoSe" HeaderText="所属角色"></asp:BoundField>
                        <asp:BoundField DataField="IfLogin" HeaderText="登陆系统"></asp:BoundField>
                    </Columns>
