...
<body>
    ...
    <div>
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px; width: 263px;">
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton5" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnModify.jpg"
                        ...
                        OnClientClick="javascript:return CheckModify();" style="height: 17px" />&nbsp;
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="部门名称">
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "BuMenInfo.aspx?View=List&Type=" + Request.QueryString["Type"].ToString() + "&DirID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "BuMenName")%></asp:HyperLink>
                                </ItemTemplate>
                            ...
                            <asp:BoundField DataField="AddTime" HeaderText="添加日期"></asp:BoundField>
    ...
    <asp:Panel ID="Panel2" runat="server" Height="50px" Width="100%" Style="padding-top: 20px;
        padding-left: 20px;">
        <asp:TreeView ID="ListTreeView" runat="server" ExpandDepth="2" Font-Bold="False"
            ShowLines="True">
        </asp:TreeView>
    </asp:Panel>
    </form>
