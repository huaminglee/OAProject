...
public partial class CRM_BaoJiaModify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.txtBaoJiaTime.Value = model.BaoJiaTime;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        model.BaoJiaTime = this.txtBaoJiaTime.Value;
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "报价信息修改成功！", "MyCustomPrice.aspx?CustomName=" + Request.QueryString["CustomName"].ToString());
    }
}