<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DengjiInfo.aspx.cs"
    Inherits="CRM_CallRecordsInfo" %>
        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;上访登记管理&nbsp;>>&nbsp;添加上访登记记录
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <img src="../images/Button/JianGe.jpg" /><img
            ...
            <tr>
                <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                    &nbsp; &nbsp;&nbsp; 选择过滤条件：<asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem Value="UName">用户姓名</asp:ListItem>
                        <asp:ListItem Value="Telephone">手机号码</asp:ListItem>
                        <asp:ListItem Value="Description">上访描述</asp:ListItem>
                    </asp:DropDownList>
                    过滤内容：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="85px"></asp:TextBox>
                    &nbsp; 添加时间：<asp:TextBox ID="TextBox2" runat="server" Height="20px" Width="80px"></asp:TextBox><img
                        class="HerCss" onclick="var dataString = showModalDialog('../JS/calendar.htm', 'yyyy-mm-dd' ,'dialogWidth:286px;dialogHeight:221px;status:no;help:no;');if(dataString==null){}else{document.getElementById('TextBox2').value=dataString;}"
            ...
            <td>
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="UName" HeaderText="用户姓名"></asp:BoundField>
                        <asp:BoundField DataField="Telephone" HeaderText="联系电话"></asp:BoundField>
                        <asp:BoundField DataField="Description" HeaderText="描述"></asp:BoundField>
                        <asp:BoundField DataField="RecordTime" HeaderText="添加时间"></asp:BoundField>
                    </Columns>
