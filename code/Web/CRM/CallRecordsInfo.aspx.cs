...
public partial class CRM_CallRecordsInfo : System.Web.UI.Page
{
    ...
    public string GetTimeCondition()
    {
        ...
        {
            ConditionStr = ConditionStr + " and AddTime>='" + this.TextBox2.Text.Trim() + " 00:00:00' ";
        }
        if (DateTime.TryParse(this.TextBox3.Text.Trim(), out MyDateSec) == true)
        {
            ConditionStr = ConditionStr + " and AddTime<='" + this.TextBox3.Text.Trim() + " 23:59:59' ";
        }
        return ConditionStr;
    }
    public void DataBindToGridview()
    {
        ZWL.BLL.ERPCallRecords MyModel = new ZWL.BLL.ERPCallRecords();
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from dbo.ERPCallRecords where ID in (" + IDlist + ")") == -1)
        {
        ...
        else
        {
            ...
            MyRiZhi.DoSomething = "用户删除访客记录信息";
    ...
    {
        Response.Redirect("CallRecordsAdd.aspx");
    }
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("CallRecordsModify.aspx?id=" + CheckStrArray[0].ToString());
        }
        else
        {
