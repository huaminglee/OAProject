...
public partial class CRM_CallRecordsInfo : System.Web.UI.Page
{
    ...
    public string GetTimeCondition()
    {
        ...
        {
            ConditionStr = ConditionStr + " and RecordTime>='" + this.TextBox2.Text.Trim() + " 00:00:00' ";
        }
        if (DateTime.TryParse(this.TextBox3.Text.Trim(), out MyDateSec) == true)
        {
            ConditionStr = ConditionStr + " and RecordTime<='" + this.TextBox3.Text.Trim() + " 23:59:59' ";
        }
        return ConditionStr;
    }
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from dbo.ERPDengJi where ID in (" + IDlist + ")") == -1)
        {
    ...
    {
        Response.Redirect("DengJiAdd.aspx");
    }
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("DengJiModify.aspx?id=" + CheckStrArray[0].ToString());
        }
        else
        {
