...
public partial class CRM_FuWuAdd : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        model.FuWuTime = this.txtFuWuTime.Value;
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "服务记录信息添加成功！", "MyCustomService.aspx?CustomName=" + Request.QueryString["CustomName"].ToString());
    }
}