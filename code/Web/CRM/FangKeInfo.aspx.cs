...
public partial class CRM_StudentInfo : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            ImageButton1.Visible = ZWL.Common.PublicMethod.StrIFIn("|xs006A|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = ZWL.Common.PublicMethod.StrIFIn("|xs006D|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = ZWL.Common.PublicMethod.StrIFIn("|xs006E|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
    ...
    {
        ZWL.BLL.ERPFangKe MyModel = new ZWL.BLL.ERPFangKe();

        DataSet ds = MyModel.GetList(" " + this.DropDownList1.SelectedItem.Value.ToString() + " Like '%" + this.TextBox1.Text + "%' " + GetTimeCondition() + " order by ID desc");
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from dbo.ERPFangKe where ID in (" + IDlist + ")") == -1)
        {
    ...
    {
        Response.Redirect("FangKeAdd.aspx");
    }
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("FangKeModify.aspx?id=" + CheckStrArray[0].ToString());
        }
        else
        {
