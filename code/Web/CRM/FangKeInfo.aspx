<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FangKeInfo.aspx.cs" Inherits="CRM_StudentInfo" %>
        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;访客管理&nbsp;>>&nbsp;访客信息
                </td>
            ...
            <tr>
                <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                    &nbsp; &nbsp;&nbsp; 选择过滤条件：<asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem Value="Telephone">联系方式</asp:ListItem>
                        <asp:ListItem Value="Receiver">接待人</asp:ListItem>
                        <asp:ListItem Value="SourceFrom">客户来源</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="客户姓名">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"><%# DataBinder.Eval(Container.DataItem, "CustomerName")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="Telephone" HeaderText="联系方式"></asp:BoundField>
                        <asp:BoundField DataField="Receiver" HeaderText="接待人"></asp:BoundField>
                        <asp:BoundField DataField="PetitionTime" HeaderText="上访时间"></asp:BoundField>
                        <asp:BoundField DataField="Description" HeaderText="上访记录"></asp:BoundField>
                        <asp:BoundField DataField="SourceFrom" HeaderText="访客来源"></asp:BoundField>
                        <asp:BoundField DataField="AddTime" HeaderText="创建时间"></asp:BoundField>
                    </Columns>
