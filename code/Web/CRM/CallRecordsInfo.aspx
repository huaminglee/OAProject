<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CallRecordsInfo.aspx.cs"
            ...
            <tr>
                <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                    &nbsp; &nbsp;&nbsp; 选择过滤条件：<asp:DropDownList ID="DropDownList1" runat="server">
                        <asp:ListItem Value="Telephone">联系电话</asp:ListItem>
                        <asp:ListItem Value="Receiver">接待人</asp:ListItem>
                        <asp:ListItem Value="UName">访客姓名</asp:ListItem>
                    </asp:DropDownList>
