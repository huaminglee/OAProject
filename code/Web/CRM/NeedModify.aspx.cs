...
public partial class CRM_NeedModify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.txtNeedTime.Value = model.NeedTime;
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        model.NeedTime = this.txtNeedTime.Value;
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "需求信息修改成功！", "MyCustomNeed.aspx?CustomName=" + Request.QueryString["CustomName"].ToString());
    }
}