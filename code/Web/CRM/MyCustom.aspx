                ...
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="客户名称">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "CustomView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "CustomName")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="YuJiDingDanDate" HeaderText="预计订单日期"></asp:BoundField>
                        <asp:BoundField DataField="ChargeMan" HeaderText="负责人"></asp:BoundField>
                        <asp:BoundField DataField="TelStr" HeaderText="联系电话"></asp:BoundField>
                        <asp:BoundField DataField="ZhuangTai" HeaderText="客户状态"></asp:BoundField>
                        <asp:BoundField DataField="LeiBie" HeaderText="客户类别"></asp:BoundField>
                        <asp:BoundField DataField="JiBie" HeaderText="客户级别"></asp:BoundField>
        ...
        <tr>
            <td style="border-top: #000000 1px solid; border-bottom: #000000 1px solid">
                ...
                <img align="absMiddle" src="../images/TreeImages/test.gif" /><asp:HyperLink ID="HyperLink2"
                    runat="server" Font-Bold="True" Font-Underline="True" ForeColor="Red" NavigateUrl="~/CRM/CustomInfo.aspx?Type=Share">查看共享业务数据</asp:HyperLink>
            </td>
        </tr>
    </table>
    </form>
