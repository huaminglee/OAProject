...
public partial class _Default : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //        {
        //            //序列号错误
        //           // ZWL.Common.MessageBox.ShowAndRedirect(this, "系统授权码验证无效！请联系电脑科技重新获取授权！", "SerilsSetting.aspx");
        //        }
        //    }
        //    catch
        //    {
        //        //ZWL.Common.MessageBox.ShowAndRedirect(this, "系统授权码验证无效！请联系电脑科技科技重新获取授权！", "SerilsSetting.aspx");
        //    }

        //    try
        //    {
        //        //时间字符串-----------------------------------------------------------------------------
        //        DateTime DateStr = DateTime.Parse(ZWL.Common.DEncrypt.DESEncrypt.Decrypt(ZWL.DBUtility.DbHelperSQL.GetSHSL("select top 1 DateStr from ERPSerils"), "www.baidu.com"));
        //        if (DateStr < DateTime.Now)
        //        {
        //            //使用时间到达
        //            ZWL.Common.MessageBox.ShowAndRedirect(this, "系统授权码过期！请联系电脑科技重新获取授权！", "SerilsSetting.aspx");
        //        }
        //    }
        //    catch
        //    {
