...
public partial class Project_JinDuModify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            this.txtStartTime.Value = model.StartTime.ToString().Split(' ')[0];
            this.txtEndTime.Value = model.EndTime.ToString().Split(' ')[0];
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        model.StartTime = DateTime.Parse(this.txtStartTime.Value);
        model.EndTime = DateTime.Parse(this.txtEndTime.Value);
