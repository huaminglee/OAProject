<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KaoQingChaXunTongJi.aspx.cs"
    Inherits="HR_KaoQingChaXunTongJi" %>
            ...
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<asp:ImageButton ID="ImageButton2" runat="server"
                        ImageUrl="../images/Button/BtnReport.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton2_Click" /><img
            ...
            <tr>
                <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                    &nbsp; &nbsp; 所属部门：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="80px"></asp:TextBox><img
                        ...
                        src="../images/Button/search.gif" />&nbsp; 起至日期：
                    ...
                    <asp:ImageButton ID="ImageButton4" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
                        OnClick="ImageButton4_Click" />&nbsp;&nbsp;&nbsp;<span style="color: #0000cc">&nbsp;注：每次只可查询单一部门，不选择即代表所有</span>
                </td>
            </tr>
        </table>
    </div>
                ...
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="正常">
                            <ItemTemplate>
                                <asp:Label ID="Label1" ToolTip='<%# DataBinder.Eval(Container.DataItem, "UserName") %>'
