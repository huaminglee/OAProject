...
public partial class HRNew_RenShiHeTongModify : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.txtQianYueDate.Value = Model.QianYueDate.ToString();
            this.txtManYueDate.Value = Model.ManYueDate.ToString();
			this.txtJianZhengJiGuan.Text=Model.JianZhengJiGuan.ToString();
            this.txtJianZhengDate.Value = Model.JianZhengDate.ToString();
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.QianYueDate = this.txtQianYueDate.Value.ToString();
        Model.ManYueDate = this.txtManYueDate.Value.ToString();
		Model.JianZhengJiGuan=this.txtJianZhengJiGuan.Text.ToString();
        Model.JianZhengDate = this.txtJianZhengDate.Value.ToString();
