...
public partial class DocFile_PeiXunModify : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.txtStartDate.Value = Model.StartDate.ToString();
            this.txtEndDate.Value = Model.EndDate.ToString();
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.StartDate = this.txtStartDate.Value.ToString();
        Model.EndDate = this.txtEndDate.Value.ToString();
