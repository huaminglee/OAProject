...
public partial class Car_CarBaoXianModify : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.txtBaoXianDate.Value = Model.BaoXianDate.ToString();
            this.txtTiXingDate.Value = Model.TiXingDate.ToString();
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.BaoXianDate = this.txtBaoXianDate.Value.ToString();
