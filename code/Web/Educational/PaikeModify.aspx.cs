...
public partial class CRM_CustomModify : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //txtTimeStr.Text = model.TimeStr.ToString();

        }
    }
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        if (ZWL.Common.PublicMethod.IFExists("Name", "ERPPaike", int.Parse(Request.QueryString["ID"].ToString()), this.txtCustomerName.Value) == true)
        {
            ...
            DateTime TimeStr = Convert.ToDateTime(txtTimeStr.Value);
            ...
            MyRiZhi.DoSomething = "用户修改客户信息(" + this.txtCustomerName.Value + ")";
            MyRiZhi.IpStr = System.Web.HttpContext.Current.Request.UserHostAddress.ToString();
            MyRiZhi.Add();

            ZWL.Common.MessageBox.ShowAndRedirect(this, "客户信息修改成功！", "paike.aspx");
        }
        else
        {
