<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Teacher.aspx.cs" Inherits="Educational_Course" %>
        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;教师管理&nbsp;>>&nbsp;教师信息
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    &nbsp;&nbsp;<img src="../images/Button/JianGe.jpg" /><img class="HerCss" onclick="javascript:window.history.go(-1)"
            ...
            <tr>
                <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                    &nbsp; &nbsp;&nbsp; 选择过滤条件：<asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem Value="Addresss">地址</asp:ListItem>
                    </asp:DropDownList>
            ...
            <td>
                <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Name" HeaderText="教师姓名"></asp:BoundField>
                        <asp:BoundField DataField="Age" HeaderText="年龄"></asp:BoundField>
                        <asp:BoundField DataField="Birth" HeaderText="生日"></asp:BoundField>
                        <asp:BoundField DataField="Mobile" HeaderText="联系方式"></asp:BoundField>
