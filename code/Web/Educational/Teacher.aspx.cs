...
public partial class Educational_Course : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            ImageButton1.Visible = ZWL.Common.PublicMethod.StrIFIn("|xs007A|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton3.Visible = ZWL.Common.PublicMethod.StrIFIn("|xs007D|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = ZWL.Common.PublicMethod.StrIFIn("|xs007E|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
    ...
    {
        ZWL.BLL.ERPTeacher MyModel = new ZWL.BLL.ERPTeacher();
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from dbo.ERPTeacher where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("TeacherModify.aspx?id=" + CheckStrArray[0].ToString());
        }
        else
        {
