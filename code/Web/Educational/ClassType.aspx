<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassType.aspx.cs" Inherits="Educational_Course" %>
        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;字典维护&nbsp;>>&nbsp;字典列表
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    名称：<asp:TextBox ID="txtName" runat="server" Height="20px" Width="85px"></asp:TextBox>
