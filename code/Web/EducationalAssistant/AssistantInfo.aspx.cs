...
public partial class EducationalAssistant_AssistantInfo : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyModel.GetList(" " + this.DropDownList1.SelectedItem.Value.ToString() + " Like '%" + this.TextBox1.Text + "%' " + GetTimeCondition() + " and ','+ Assistant +',' like '%," + ZWL.Common.PublicMethod.GetSessionValue("UserName") + ",%'  " + " order by ID desc");
