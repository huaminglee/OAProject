...
<table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
	<tr>
	<td style="width: 232px; height: 25px; background-color: #cccccc" align="right">
        开发商名称：
	</td>
	<td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
        电脑科技有限公司</td></tr>
    <tr>
        <td align="right" style="width: 232px; height: 25px; background-color: #cccccc">
            公司网站：</td>
        <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
            http://www.baidu.com</td>
    </tr>
    <tr>
        <td align="right" style="width: 232px; height: 25px; background-color: #cccccc">
            联系电话：</td>
    ...
    <tr>
        ...
        <A 
href="tencent://message/?uin=9618195&amp;Site=http://www.baidu.com/&amp;Menu=yes" 
