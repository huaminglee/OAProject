...
public partial class SelectUser2 : System.Web.UI.Page
{
    ...
    private void BindTree(TreeNodeCollection Nds, int IDStr)
    {
        ...
        SqlConnection Conn = new SqlConnection(ZWL.Common.DEncrypt.DESEncrypt.Decrypt(ConfigurationManager.AppSettings["SQLConnectionString"].ToString()));
        ...
        while (MyReader.Read())
        {
            ...
            SqlConnection Conn1 = new SqlConnection(ZWL.Common.DEncrypt.DESEncrypt.Decrypt(ConfigurationManager.AppSettings["SQLConnectionString"].ToString(), "zhangweilong"));
            Conn1.Open();
