<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectCondition.aspx.cs"
    Inherits="SelectCondition" %>
...
<head>
    ...
    <script language="javascript">
        ...
        function CheckSelect() {
            var cbvalue = "";
            var cbnewlist = document.getElementsByName("cbNewList");
            for (var i = 0; i < cbnewlist.length; i++) {
                var e = cbnewlist[i];
                if (e.checked) {
                    if (cbvalue == "") {
                        cbvalue = e.value;
