...
<body>
    ...
    <div>
        <table id="PrintHide" style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" style="border-bottom: #006633 1px dashed; height: 30px; width: 140px;">
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    <a href="MyDeskSetting.aspx">
                        <img align="absMiddle" border="0" src="../images/Button/Setting.gif" /></a>
                    &nbsp;<img src="../images/Button/JianGe.jpg" />&nbsp;
                    <img class="HerCss" onclick="javascript:window.history.go(-1)" src="../images/Button/BtnExit.jpg" />&nbsp;
                </td>
            </tr>
            <tr>
                <td height="3px" colspan="3" style="background-color: #ffffff">
                </td>
            </tr>
        </table>
    </div>
