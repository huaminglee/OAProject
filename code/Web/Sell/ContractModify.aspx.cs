...
public partial class Sell_ContractModify : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.txtShengXiaoDate.Value = Model.ShengXiaoDate.ToString().Replace(" 0:00:00", "");
            this.txtZhongZhiDate.Value = Model.ZhongZhiDate.ToString().Replace(" 0:00:00", "");
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.ShengXiaoDate = DateTime.Parse(this.txtShengXiaoDate.Value);
        Model.ZhongZhiDate = DateTime.Parse(this.txtZhongZhiDate.Value);
