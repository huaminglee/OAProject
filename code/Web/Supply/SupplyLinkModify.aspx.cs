...
public partial class Supply_SupplyLinkModify : System.Web.UI.Page
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		if (!Page.IsPostBack)
		{
            ...
            this.txtShengRi.Value = Model.ShengRi.ToString().Replace(" 0:00:00", "");
	...
	protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
	{
        ...
        Model.ShengRi = DateTime.Parse(this.txtShengRi.Value);
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "供应商联系人信息修改成功！", "SupplysLink.aspx?GongYingShang=" + Request.QueryString["GongYingShang"].ToString());
	}
}
