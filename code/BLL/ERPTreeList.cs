...
namespace ZWL.BLL
{
    ...
    public class ERPTreeList
    {
        ...
        public ERPTreeList(int ID)
        {
            ...
            strSql.Append("select ID,TextStr,ImageUrlStr,ValueStr,NavigateUrlStr,Target,ParentID,QuanXianList,PaiXuStr ");
        ...
        public int Add()
        {
            ...
            strSql.Append("TextStr,ImageUrlStr,ValueStr,NavigateUrlStr,Target,ParentID,QuanXianList,PaiXuStr)");
            ...
            parameters[2].Value = ValueStr;
            parameters[3].Value = NavigateUrlStr;
            parameters[4].Value = Target;
            parameters[5].Value = ParentID;
            parameters[6].Value = QuanXianList;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,TextStr,ImageUrlStr,ValueStr,NavigateUrlStr,Target,ParentID,QuanXianList,PaiXuStr ");
            strSql.Append(" FROM ERPTreeList ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
