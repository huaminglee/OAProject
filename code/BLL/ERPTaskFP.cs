...
namespace ZWL.BLL
{
    ...
    public class ERPTaskFP
    {
        ...
        public ERPTaskFP(int ID)
        {
            ...
            strSql.Append("select ID,TaskTitle,TaskContent,FromUser,ToUserList,XinXiGouTong,JinDu,WanCheng,NowState ");
        ...
        public int Add()
        {
            ...
            strSql.Append("TaskTitle,TaskContent,FromUser,ToUserList,XinXiGouTong,JinDu,WanCheng,NowState)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,TaskTitle,TaskContent,FromUser,ToUserList,XinXiGouTong,JinDu,WanCheng,NowState ");
            strSql.Append(" FROM ERPTaskFP ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
